...
{
	public Ecs.Game.Components.Common.PrefabComponent Prefab { get { return (Ecs.Game.Components.Common.PrefabComponent)GetComponent(GameComponentsLookup.Prefab); } }
	...
	public void AddPrefab(string newName)
	{
		...
		var component = (Ecs.Game.Components.Common.PrefabComponent)CreateComponent(index, typeof(Ecs.Game.Components.Common.PrefabComponent));
	...
	public void CopyPrefabTo(Ecs.Game.Components.Common.PrefabComponent copyComponent)
	{
		var index = GameComponentsLookup.Prefab;
		var component = (Ecs.Game.Components.Common.PrefabComponent)CreateComponent(index, typeof(Ecs.Game.Components.Common.PrefabComponent));
		#if !ENTITAS_REDUX_NO_IMPL
