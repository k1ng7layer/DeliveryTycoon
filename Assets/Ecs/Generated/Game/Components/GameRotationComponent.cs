...
{
	public Ecs.Game.Components.Common.RotationComponent Rotation { get { return (Ecs.Game.Components.Common.RotationComponent)GetComponent(GameComponentsLookup.Rotation); } }
	...
	public void AddRotation(UnityEngine.Quaternion newValue)
	{
		...
		var component = (Ecs.Game.Components.Common.RotationComponent)CreateComponent(index, typeof(Ecs.Game.Components.Common.RotationComponent));
	...
	public void CopyRotationTo(Ecs.Game.Components.Common.RotationComponent copyComponent)
	{
		var index = GameComponentsLookup.Rotation;
		var component = (Ecs.Game.Components.Common.RotationComponent)CreateComponent(index, typeof(Ecs.Game.Components.Common.RotationComponent));
		#if !ENTITAS_REDUX_NO_IMPL
