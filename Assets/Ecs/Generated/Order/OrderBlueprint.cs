...
/// <see cref="OrderEntity"/>.
/// </summary>
[CreateAssetMenu(fileName = "NewOrderBlueprint", menuName = "EntitasRedux/Order/OrderBlueprint")]
public partial class OrderBlueprint : BlueprintBase, IOrderBlueprint
{
	/// <summary>
	/// Applies all components in the blueprint to <paramref name="entity"/>.
	/// </summary>
	/// <param name="entity"></param>
	public void ApplyToEntity(OrderEntity entity)
	{
		for (var i = 0; i < _components.Count; i++)
		{
			...
			var index = OrderComponentsLookup.GetComponentIndex(component);
			if (index != -1)
			{
	...
	protected override void OnValidate()
	{
		...
		{
			var index = OrderComponentsLookup.GetComponentIndex(_components[i]);
			if (index == -1)
			{
