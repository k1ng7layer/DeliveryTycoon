...
{
    [Serializable, NodeMenuItem(TaskNames.HAS_CARGO_PATH)]
    public class HasCargoConditionNode : ABehaviourTreeNode
    {
        [GraphProcessor.Input("In"), Vertical]
        public float input;
		
        public override string name => TaskNames.HAS_CARGO;
    }
    
    public class HasCargoConditionBuilder : ATaskBuilder
    {
        public override string Name => TaskNames.HAS_CARGO;
